...
List<Food> mockFoods = [
  ...
  Food(
    ...
    ingradient:
        'Nasi, Daging Kambing, Bawang Merah, Bawang Putih, Kecap Manis, Cabai, Rempah-rempah',
    price: 25000,
    rate: 4.5,
  ),
  Food(
  ...
  Food(
    ...
    ingradient:
        'Daging Sapi, Tepung Tapioka, Bawang Putih, Kuah Kaldu Sapi, Mie',
    price: 30000,
    rate: 4.3,
  ),
  Food(
  ...
  Food(
    ...
    ingradient:
        'Daging Sapi, Santan, Bawang Merah, Bawang Putih, Serai, Daun Jeruk, Cabai',
    price: 70000,
    rate: 4.9,
  ),
];
